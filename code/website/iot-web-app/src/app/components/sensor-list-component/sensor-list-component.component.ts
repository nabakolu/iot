...
import { SensorListComponentDataSource, SensorListComponentItem } from './sensor-list-component-datasource';
...
export class SensorListComponentComponent implements AfterViewInit {
  ...
  @ViewChild(MatTable) table!: MatTable<SensorListComponentItem>;
  ...
  constructor() {
    this.dataSource = new SensorListComponentDataSource();
  }
