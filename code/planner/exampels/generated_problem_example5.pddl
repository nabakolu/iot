...
;generated part
(= (co2) 0.6198000000000008)
(closed window_west)
(action_available window_west)
(= (wind window_west) 0.09333333333333335)
(= (ambientnoise window_west) 1)
(= (rain window_west) 0.0)
(open window_east)
(action_available window_east)
(= (wind window_east) 0)
(= (ambientnoise window_east) 0.40675000000000006)
...
(= (curr_temp central_heater) 22.41)
(= (temperatureDiffMinimum central_heater) -3.710000000000001)
(= (temperatureDiffOutside central_heater) 2.5)
