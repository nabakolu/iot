...
(= (wind window_east) 0.8960000000000001)
...
(= (curr_temp central_heater) 22.32)
(= (temperatureDiffMinimum central_heater) -3.620000000000001)
(= (temperatureDiffOutside central_heater) 2.3999999999999986)
